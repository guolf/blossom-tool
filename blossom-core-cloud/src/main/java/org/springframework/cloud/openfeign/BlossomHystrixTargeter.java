...
import org.springblossom.core.cloud.feign.BlossomFallbackFactory;
import org.springframework.lang.Nullable;

/**
 * 添加 默认的 fallbackFactory
 * @author guolf
 */
public class BlossomHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		BlossomFallbackFactory micaFallbackFactory = new BlossomFallbackFactory(target);
