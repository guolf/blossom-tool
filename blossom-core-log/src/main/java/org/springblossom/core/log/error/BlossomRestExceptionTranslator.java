...
public class BlossomRestExceptionTranslator {
	...
	public R handleError(ConstraintViolationException e) {
		...
		log.error("{}:{}",path, violation.getMessage());
	...
	@ExceptionHandler(value = {SecureException.class, AuthenticationException.class})
	...
	@ExceptionHandler(value = NeedTwoFactorException.class)
	@ResponseStatus(HttpStatus.PAYMENT_REQUIRED)
	public R handleError(NeedTwoFactorException e) {
		log.error("缺少验证码", e);
		return R.fail(ResultCode.PAYMENT_REQUIRED, e.getMessage());
	}
