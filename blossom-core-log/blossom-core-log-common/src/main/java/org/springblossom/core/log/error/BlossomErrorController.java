 ...
 * @author Chill
 */
public class BlossomErrorController extends BasicErrorController {

	public BlossomErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
