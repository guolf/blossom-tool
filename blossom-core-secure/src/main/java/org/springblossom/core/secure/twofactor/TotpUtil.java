...
public class TotpUtil {
	 ...
	 * @return
	 */
	public static String generateTotpString(String account, String domain, String secretBase32) {
		return "otpauth://totp/" + account + "@" + domain + "?secret=" + secretBase32;
	}
	...
	public static String generate(String secretBase32) {
		...
		try {
			...
			return generateTOTP(secretHex, steps.toString(), "6", "HmacSHA1");
