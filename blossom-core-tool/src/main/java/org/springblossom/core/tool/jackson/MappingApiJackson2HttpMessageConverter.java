 ...
 */
package org.springblossom.core.tool.jackson;
...
//		// null 处理
//		writeObjectMapper.setSerializerFactory(writeObjectMapper.getSerializerFactory().withSerializerModifier(new BlossomBeanSerializerModifier()));
//		writeObjectMapper.getSerializerProvider().setNullValueSerializer(BlossomBeanSerializerModifier.NullJsonSerializers.STRING_JSON_SERIALIZER);
//		return writeObjectMapper;

		return readObjectMapper;
	}
