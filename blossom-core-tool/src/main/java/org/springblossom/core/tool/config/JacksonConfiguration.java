 ...
 */
package org.springblossom.core.tool.config;
...
import org.springblossom.core.tool.jackson.BlossomJavaTimeModule;
import org.springblossom.core.tool.jackson.deserializer.XssStringJsonDeserializer;
...
public class JacksonConfiguration {
	...
	public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
		...
		//日期格式化
		objectMapper.registerModule(new BlossomJavaTimeModule());
		objectMapper.findAndRegisterModules();
