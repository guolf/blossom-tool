...
public class BlossomFileUtil {
	 ...
	 * @return BlossomFile
	 */
	public static BlossomFile getFile(MultipartFile file) {
	 ...
	 * @return BlossomFile
	 */
	public static BlossomFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return BlossomFile
	 */
	public static BlossomFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new BlossomFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return BlossomFile
	 */
	public static List<BlossomFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return BlossomFile
	 */
	public static List<BlossomFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return BlossomFile
	 */
	public static List<BlossomFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<BlossomFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new BlossomFile(file, dir, path, virtualPath));
		}
		return list;
	}
