...
import org.springblossom.core.tool.utils.ImageUtil;
 ...
 * @author Chill
 */
public class BlossomFileProxyFactory implements IFileProxy {
	...
	public String[] path(File f, String dir) {
		...
		return new String[]{BlossomFileUtil.formatUrl(uploadPath.toString()), BlossomFileUtil.formatUrl(virtualPath.toString())};
	}
