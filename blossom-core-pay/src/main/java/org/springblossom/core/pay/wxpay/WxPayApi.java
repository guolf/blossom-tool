...
public class WxPayApi {
	...
	public static String doPost(String url, Map<String, String> params) {
		return OkHttpUtil.postContent(url, null, WxPayKit.toXml(params), MediaType.parse(""));
	}

	public static String doPostSSL(String url, Map<String, String> params, String certPath, String certPass) {
		return null;
		// HttpKit.getDelegate().postSSL(url, WxPayKit.toXml(params), certPath, certPass);
	}

	public static String doPostSSL(String url, Map<String, String> params, InputStream certFile, String certPass) {
		return null; //HttpKit.getDelegate().postSSL(url, WxPayKit.toXml(params), certFile, certPass);
	}
}
